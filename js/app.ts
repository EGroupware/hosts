...
class HostsApp extends EgwApp
{
	// app name
	readonly appname = 'hosts';
	 ...
	 * @param {string} name template name et2_ready is called for eg. "hosts.edit"
	 */
	et2_ready(et2,name)
	{
		// call parent
	...
	{
		var row_id = _selected[0].id;	// "hosts::123"
		...
		dialog.transformAttributes({
			...
			template: this.egw.webserverUrl+'/hosts/templates/default/edit.xet',
			width: 400,
			value: values
		});
